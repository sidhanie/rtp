var commentusername = ["ready", "Giselda Capon", "Fausto Greco", "Lia Piazza", "Anacleto", "Batista", "Priscilla", "Adelia Conti", "Marilena", "Ivo Zetticci", "Chris Jericho", "Abelardo", "Jonathan", "Mafalda", "Sam", "Igor", "Andrew", "Eliano Fallaci", "Ermes", "Calvin", "Concordio", "", "Mantap", "Gila sih", "Shiittt", "Keren", "Keren", "Jp terus", "Mantap cok", "Anjay mabar", "Infonya suhu", "Caranya?", "Gila Bos, bisa dong", "Mantulllll", "! ", ". ", ".. ", " ", "Wow", "WOW", "wow", "Ga percaya, beneran bisa cok", "Keren parah coy", "Gacor kali ", "this is legit website ", "Makasih bos cheatnya ", "thanks for sharing ", "awesome man! you should sell this method,i'ts really working", "I can not believe believe that this really works, Mantap cok", "Keren cheatnya", "Jp mulu gua minn thxx ", " ", " ", " ", "", " ", "", "", "", "", "", "", "amazing tool bro. thanks you so much for sharing this ", "thank you admin! works for me!", "the most powerful tool ever! thank you ", "i wonder why this wasnÃ¢â‚¬â„¢t on the news. this is stunning tool! ", "thanks a lot dude!!!! WORKS like a charm!!! ", "Osemmm mantap", " Makasih banyak cheatnya gan, ane jp mulu ", "that was amazing!!! thanks a lot for this online Boom Beach hack. ", "works like a charm.. thanks admin.. ", "thanks! I was looking for this in a long time! ", "", "", "", "", "", "", "", "", "", "", "", "", " ", " ", " ", " ", "  ", " ", "", "", "", "", "Bisa! Mantap Cheatnya!! ", "Makasih min! ", "Ini nih yang gue cari! ", "Makasih sudah share min  ", " ", " ", " ", "Makasih", "Makasih", "Makasih banyak", "Makasih banyak", "Banyak makasih XD", "Mantap", "Gacor juga cheatnya wkwkw", "Tq min", ":D ", ":3 ", ":) ", "c: ", "=D ", "=3 ", "=) ", "c= ", "commented", "state-disabled", "addClass", "#commentUsernameLabel", "disabled", "attr", "#commentUsername", "#commentCommentLabel", "#commentComment", "comment1Cookie", "username1Cookie", "username2Cookie", "username3Cookie", "timePosted11Cookie", "timePosted22Cookie", "timePosted33Cookie", "comment2Cookie", "comment3Cookie", "click", "#commentSubmit", "random", "floor", "join", "length", "html", "#username", " ", "#comment", "#timePosted", "Posted few seconds ago", "Posted a minute ago", "Posted ", " minutes ago", "round", "val", "state-error", "getTime", "setTime", "; expires=", "toGMTString", "cookie", "=", "; path=/", ";", "split", "substring", "charAt", "indexOf"];
